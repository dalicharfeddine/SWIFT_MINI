...
struct VerificationOtpScreen: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Text("Verification code").font(.system(size:30)).frame(maxWidth:.infinity, alignment:.leading).foregroundColor(.white)
                .padding(.bottom,5)
            ...
            HStack{
                ...
                Text("Didn't receive the code?").foregroundColor(Color.white)
